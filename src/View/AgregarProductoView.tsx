      ...
      <div className='ContenedorAgregar'>
        ...
        <div className='Segunda-seccion'>
          <div className='form-group'>
            ...
            <input type="text" placeholder='Agrega un nombre' value={title} onChange={(e) => setTitle(e.target.value)} />
          </div>
          <div className='form-group'>
            <h2>Categoría</h2>
            <select>
          ...
          <div className='form-group'>
            <h2>Precio</h2>
            <input type="number" placeholder='Agrega un precio' value={price} onChange={(e) => setPrice(e.target.value)} />
          </div>
        </div>
        ...
        <div className='Tercera-seccion'>
          <div className='form-group'>
            ...
            <input type="text" placeholder='Escriba aquí la descripción del producto' value={description} onChange={(e) => setDescription(e.target.value)} />
          </div>
          <div className='form-group'>
